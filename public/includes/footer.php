    ...
    <div class="footer-content">
      ...
      <div class="footer-bottom">
        ...
        <div class="footer-social">
          <a href="https://github.com/dedeusgui/ProjetoFullstack" class="social-link" aria-label="GitHub" title="GitHub"
...
<!-- Settings Modal JS -->
<script src="assets/js/settings-modal.js?v=<?php echo filemtime(__DIR__ . '/../assets/js/settings-modal.js'); ?>"></script>
<script src="assets/js/profile-modal.js?v=<?php echo filemtime(__DIR__ . '/../assets/js/profile-modal.js'); ?>"></script>
